...
export const gridContent = [
...

  {
    ...
    desc: "A deeply authentic Indian dish with rich, earthy masala and the unmistakable aroma of fresh curry leaves. It's not fiery hot — just full of bold, balanced flavour.",
  },
...

  {
    ...
    desc: "Quick and tasty savoury mince served with creamy mash potatoes — easy comfort food on a budget.",
  },
...

  {
    ...
    cat: "beef",
    imgSrc:
      "/images/beaters-beaf-stew/200/beaters-beef-stew-and-yorkshire-pudding-02.webp",
...

  {
    ...
    caption: "aloo gobi",
    page: `aloo-gobi`,
    desc: "Classic Indian dry curry of potato and cauliflower with fragrant spices — vegan and full of flavour.",
  },
...

  {
    ...
    page: `fish-pie`,
    desc: "Traditional creamy fish pie with a mash potato topping — comforting, filling, and a real family favourite.",
  },
...

  {
    ...
    caption: "onion sauce",
    page: `onionsauce`,
    desc: "Sweet, savoury onion sauce made from soft - cooked onions — ideal with roast chicken, sausages or pork.",
  },
...

  {
    ...
    page: `tomato-chutney`,
    desc: "Sweet and tangy tomato chutney with a gentle chilli kick — ideal with pork pie, sausage rolls or cold cuts.",
  },
...

  {
    ...
    desc: "Creamy, cloud-like mashed potatoes with just the right balance of butter, seasoning, and fluff — perfect alongside roasts, stews, or simply with gravy!",
  },
